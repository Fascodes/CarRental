...
import { getCar, patchCarAdmin } from '../api/cars'
      ...
      <div className="form-card" style={{ maxWidth: 600 }}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="btn-group">
            ...
            <button type="button" className="btn btn-secondary" onClick={() => navigate(-1)}>Wróć</button>
          </div>
        </form>
      </div>
    </div>
